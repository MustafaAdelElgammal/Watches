	...
	function stickyHeader(){
		$(window).on('scroll', function(){
		    ...
		    if ($(window).scrollTop() >= headerHeight) {
				...
				$('.fixed-logo').addClass('sticky-logo');
				$('#social-header').css('display','none');
				$('.lang-search').css('display','none');
				$('.fixed-logo').css('display','none');
				$('.search-lang-mob').css('display','none');
				...
				$('.fixed-logo').removeClass('sticky-logo');
				$('#social-header').css('display','block');
				$('.lang-search').css('display','flex');
				$('.fixed-logo').css('display','block');
				$('.search-lang-mob').css('display','flex');
