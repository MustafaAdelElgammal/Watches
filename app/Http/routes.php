...
Route::group(['middleware' => ['Localization']], function () {
    Route::group(['prefix' => LaravelLocalization::setLocale()], function () {
        //Single Pages Start
        Route::get('/', 'Web\HomeController@index')->name('watches.home');
        Route::get('/terms-of-use', 'Web\HomeController@termsOfUse')->name('watches.terms');
        Route::get('/privacy-policy', 'Web\HomeController@privacyPolicy')->name('watches.privacyPolicy');
        Route::get('/disclaimer', 'Web\HomeController@disclaimer')->name('watches.disclaimer');
        Route::get('/sitemap', 'Web\HomeController@sitemap')->name('watches.sitemap');
        Route::get('/about', 'Web\HomeController@aboutUs')->name('home.about');
        Route::get('/contact-us', 'Web\HomeController@getContactUs')->name('home.contact');
        Route::get('/blogs', 'Web\HomeController@getBlogs')->name('home.blogs');
        Route::get('/store', 'Web\HomeController@getStore')->name('home.store');
        Route::get('/product-details/{slug}', 'Web\HomeController@productDetails')->name('product.details');
...
//        Route::resource('users' , 'Admin\AdminUserController');
        ...
        Route::group(array('middleware' => 'AuthRoot'), function () {
            Route::resource('permissions', 'Admin\AdminUserController@permissions');
            Route::resource('modules', 'Admin\AdminModuleController');
        });
    });
